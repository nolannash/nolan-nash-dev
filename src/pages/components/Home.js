...
const Home = () => {
  return (
    <div className="relative top-0 left-0 h-full items-center bg-transparent rounded-3xl p-8 border-double border-4 border-red-300 bg-pink-200  bg-opacity-50 shadow-2xl shadow-pink-400/30 z-3" style={{ fontFamily: "'Lexend Variable', sans-serif" }}>
