...
const About = () =>{
    return (
        <div className="relative top-0 left-0 h-full items-center bg-transparent rounded-3xl p-8 border-double border-4 border-emerald-800 bg-lime-400 bg-opacity-50 shadow-2xl shadow-emerald-800/30 z-3" style={{ fontFamily: "'VT323', sans-serif" }}>
